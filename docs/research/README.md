...
| [govon_onpremise_policy_overview.md](01_model_analysis/govon_onpremise_policy_overview.md) | GovOn의 민원 처리 구조를 기준으로, 공공기관에서 온프레미스를 유지해야 하는 이유와 클라우드가 필요한 범위를 정리한 문서 | 신규 작성 |
