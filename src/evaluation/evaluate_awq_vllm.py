...
MODEL_ID = os.getenv("MODEL_ID", "umyunsang/civil-complaint-exaone-awq")
TEST_DATA_PATH = os.getenv("TEST_DATA_PATH", "GovOn/data/processed/v2_test.jsonl")
NUM_TEST_SAMPLES = int(os.getenv("NUM_TEST_SAMPLES", "50"))
...
def main():
    ...
    avg_latency = total_time / len(test_samples) if test_samples else 0
